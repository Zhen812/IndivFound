...
def evaluate():
    ...
    for foldID in folds:
        ...
        precision = precision_score(targets_record, preds_record)
        recall = recall_score(targets_record, preds_record)
        f1 = f1_score(targets_record, preds_record)
...
if __name__ == "__main__":
    print('[Internal Validation] on [Myocardial Infarction Detection] Task with [PTB Dataset]')
    print('--' * 15)
    evaluate()
