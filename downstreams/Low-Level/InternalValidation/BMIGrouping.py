...
parser.add_argument('--label', type=str, default="BMI")
...
def evaluate_ours():
    ...
    found_model_ckpts = opt['found_model_ckpts']['bmiGrouping']
    cls_model_ckpts = opt['cls_model_ckpts']['bmiGrouping']
    folds = list(range(5))
...
if __name__ == '__main__':
    print('[Internal Validation] on [BMI Grouping] Task with [Autonomic-Aging] Dataset')
    print('--' * 15)
    evaluate_ours()
